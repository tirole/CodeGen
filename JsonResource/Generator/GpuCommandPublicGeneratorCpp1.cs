...
namespace JsonResource.Generator
{
    ...
    public partial class GpuCommandPublicGeneratorCpp : GpuCommandPublicGeneratorCppBase
    {
        /// <summary>
    ...
    foreach(var member in Info.MemberVariableInfos) { 
        ...
        if(member.RequirementInfos != null) { 
            ...
            this.Write("        auto cmd = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(detailFuncName));
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(detailFuncArg));
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class GpuCommandPublicGeneratorCppBase
    {
        #region Fields
