...
namespace JsonResource.Generator
{
 ...
 if (enumInfo.DoxyBrief != null && enumInfo.DoxyBrief != "") { 
            this.Write("    //// @brief    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(enumInfo.DoxyBrief));
            this.Write("\r\n");
 }
 if (enumInfo.Value != "") { 
            this.Write("    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(enumInfo.Name));
            this.Write(" = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(enumInfo.Value));
            this.Write(",\r\n");
 } else { 
            this.Write(" \r\n    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(enumInfo.Name));
