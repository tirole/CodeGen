...
namespace JsonResource.Generator
{
    ...
    public partial class GpuCommandGenerator : GpuCommandGeneratorBase
    {
        /// <summary>
    ...
    foreach(var member in Info.MemberVariableInfos) { 
        ...
        if(member.RequirementInfos != null) { 
            ...
            this.Write("        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(info.GetString("val", false)));
            this.Write("\r\n");
                } 
            } 
        } 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class GpuCommandGeneratorBase
    {
        #region Fields
